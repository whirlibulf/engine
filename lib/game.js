...
Game.prototype.use = function () {
    if (arguments.length === 1) {
        var system = this.systems.add(arguments[0]);
        ...
        return this.components.add(arguments[0], arguments[1]);
    }
...
Game.prototype.add = function (entityID, componentType, options) {
    ...
    if (!this.entities.addComponent(componentType, componentID, entityID)) {
    ...
    this.emit("componentCreated", componentType, this.components.get(componentType, componentID));
...
/**
 * Get all entities that have a particlar component type
 */
Game.prototype.getAll = function (componentType) {
    this.entities.getAll(componentType);
};
 ...
 */
Game.prototype.getComponents = function (componentType) {
