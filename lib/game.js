...
Game.prototype.createObject = function (id, template) {
  ...
  if (this._componentsByObject.hasOwnProperty(id)) {
  ...
  if (template) {
    for (component in template) {
      if (template.hasOwnProperty(component)) {
        this.addComponentToObject(obj, component, template[component]);
      }
    }
  }
 ...
 */
Game.prototype.addComponentToObject = function (obj, componentID, options) {
  var component;
