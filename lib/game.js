...
Game.prototype.use = function (system, component) {
  if (arguments.length === 1) {
    return this._addSystem(arguments[0]);
  }

  if (arguments.length === 2) {
    return this._addComponent(arguments[0], arguments[1]);
  }
 ...
 */
Game.prototype._addSystem = function (system) {
 ...
 */
Game.prototype._addComponent = function (id, component) {
